(function (window) {
  ...
  window.initializeOverworldGraph = function () {
    ...
    let specialEdge = createOverworldEdge(0x00, "Northwest", "N", 1, 1, 1, false, 0.3);
    specialEdge.y = specialEdge.y2 = 0.35;
    createDoubleOverworldEdge(0x00, "Northeast", "E", 1, 1, 1, false, 0.3);
    createDoubleOverworldEdge(0x00, "Southwest", "S", 0, 2, 2, false, 0.2);
    createDoubleOverworldEdge(0x00, "South", "S", 1, 2, 2, false, 0.75);
    createDoubleOverworldEdge(0x00, "Southeast", "S", 2, 1, 1, false, 1.8);
    createDoubleOverworldEdge(0x02, "Main", "W", 1, 1, 1, false, 0.3);
    createDoubleOverworldEdge(0x02, "Main", "S", 1, 1, 1, false, 0.4);
    createDoubleOverworldEdge(0x03, "Top", "E", 0, 1, 1, false, 0.25);
    createDoubleOverworldEdge(0x03, "Bottom", "E", 2, 1, 1, false, 1.65);
    createDoubleOverworldEdge(0x05, "Top West", "W", 0, 1, 1, false, 0.25);
    createDoubleOverworldEdge(0x05, "Bottom West", "W", 2, 1, 1, false, 1.65);
    createDoubleOverworldEdge(0x05, "Top Main", "E", 1, 1, 1, false, 0.25);
    createDoubleOverworldEdge(0x07, "Main", "W", 1, 1, 1, false, 0.25);
    createDoubleOverworldEdge(0x0a, "Main", "N", 1, 1, 1, false, 0.4);
    createDoubleOverworldEdge(0x0a, "Main", "S", 1, 1, 1, false, 0.55);
    createOverworldEdge(0x0f, "Main", "N", 1, 1, 1, false, 0.65);
    createDoubleOverworldEdge(0x0f, "Main", "S", 1, 1, 1, false, 0.75);
    createWhirlpool(0x0f, "Main", 0.25, 0.6);
    createDoubleOverworldEdge(0x10, "West", "N", 0, 2, 2, false, 0.2);
    createDoubleOverworldEdge(0x10, "North", "N", 2, 2, 2, false, 0.75);
    createDoubleOverworldEdge(0x10, "West", "S", 0, 2, 2, false, 0.3);
    createDoubleOverworldEdge(0x10, "South", "S", 2, 2, 2, false, 0.65);
    createDoubleOverworldEdge(0x11, "Main", "N", 1, 1, 1, false, 0.8);
    createDoubleOverworldEdge(0x11, "Main", "E", 0, 2, 2, false, 0.3);
    createDoubleOverworldEdge(0x11, "Main", "E", 2, 2, 2, false, 0.75);
    createDoubleOverworldEdge(0x11, "Main", "S", 1, 1, 1, false, 0.55);
    createDoubleOverworldEdge(0x12, "Main", "N", 1, 1, 1, false, 0.55);
    createDoubleOverworldEdge(0x12, "Main", "W", 0, 2, 2, false, 0.3);
    createDoubleOverworldEdge(0x12, "Main", "W", 2, 2, 2, false, 0.75);
    createDoubleOverworldEdge(0x12, "Main", "E", 0, 2, 2, false, 0.4);
    createDoubleOverworldEdge(0x12, "Main", "E", 2, 2, 2, false, 0.75);
    createDoubleOverworldEdge(0x12, "Main", "S", 0, 2, 2, false, 0.3);
    createDoubleOverworldEdge(0x12, "Main", "S", 2, 2, 2, false, 0.6);
    createWhirlpool(0x12, "Main", 0.5, 0.5);
    createDoubleOverworldEdge(0x13, "Rocks", "W", 0, 2, 2, false, 0.4);
    createDoubleOverworldEdge(0x13, "Main", "W", 2, 2, 2, false, 0.75);
    createDoubleOverworldEdge(0x13, "Main", "E", 1, 1, 1, false, 0.55);
    createDoubleOverworldEdge(0x14, "Main", "W", 1, 1, 1, false, 0.55);
    createDoubleOverworldEdge(0x14, "Main", "E", 1, 1, 1, false, 0.55);
    createDoubleOverworldEdge(0x15, "West", "W", 1, 1, 1, false, 0.55);
    createDoubleOverworldEdge(0x15, "River", "E", 0, 1, 3, true, 0.25);
    createDoubleOverworldEdge(0x15, "East", "E", 1, 2, 3, false, 0.45);
    createDoubleOverworldEdge(0x15, "East", "E", 2, 2, 3, false, 0.7);
    createDoubleOverworldEdge(0x15, "West", "S", 0, 2, 3, false, 0.3);
    createDoubleOverworldEdge(0x15, "River", "S", 1, 1, 3, true, 0.6);
    createDoubleOverworldEdge(0x15, "East", "S", 2, 2, 3, false, 0.8);
    createWhirlpool(0x15, "River", 0.55, 0.3);
    createWhirlpool(0x55, "River", 0.55, 0.3);
    createDoubleOverworldEdge(0x16, "River", "W", 0, 1, 3, true, 0.25);
    createDoubleOverworldEdge(0x16, "West", "W", 1, 2, 3, false, 0.45);
    createDoubleOverworldEdge(0x16, "West", "W", 2, 2, 3, false, 0.7);
    createDoubleOverworldEdge(0x16, "River", "E", 0, 1, 2, true, 0.15);
    createDoubleOverworldEdge(0x16, "East", "E", 2, 1, 2, false, 0.35);
    createDoubleOverworldEdge(0x17, "East", "N", 1, 1, 1, false, 0.75);
    createDoubleOverworldEdge(0x17, "River", "W", 0, 1, 2, true, 0.15);
    createDoubleOverworldEdge(0x17, "West", "W", 2, 1, 2, false, 0.35);
    createDoubleOverworldEdge(0x18, "Main", "N", 0, 2, 2, false, 0.3);
    createDoubleOverworldEdge(0x18, "Main", "N", 1, 2, 2, false, 0.65);
    ...
    createDoubleOverworldEdge(0x1a, "Main", "N", 0, 2, 2, false, 0.3);
    createDoubleOverworldEdge(0x1a, "Main", "N", 2, 2, 2, false, 0.6);
    createOverworldEdge(0x1a, "Main", "E", 1, 1, 1, false, 0.6);
    createOverworldEdge(0x1b, "Main", "W", 1, 1, 1, false, 0.6);
    createDoubleOverworldEdge(0x1b, "East", "E", 1, 1, 1, false, 1.3);
    createDoubleOverworldEdge(0x1b, "Southwest", "S", 0, 1, 1, false, 0.25);
    createDoubleOverworldEdge(0x1b, "South", "S", 2, 1, 1, false, 1.6);
    createDoubleOverworldEdge(0x1d, "West", "N", 0, 2, 3, false, 0.3);
    createDoubleOverworldEdge(0x1d, "River", "N", 1, 1, 3, true, 0.6);
    createDoubleOverworldEdge(0x1d, "Northeast", "N", 2, 2, 3, false, 0.8);
    createDoubleOverworldEdge(0x1d, "Southeast", "S", 1, 1, 1, false, 0.35);
    createDoubleOverworldEdge(0x1e, "Main", "S", 0, 1, 1, false, 0.25);
    createDoubleOverworldEdge(0x1e, "Main", "S", 2, 1, 1, false, 1.75);
    createDoubleOverworldEdge(0x22, "West", "W", 1, 1, 1, false, 0.6);
    createDoubleOverworldEdge(0x25, "Main", "N", 1, 1, 1, false, 0.35);
    createDoubleOverworldEdge(0x25, "Main", "W", 1, 1, 1, false, 0.3);
    createDoubleOverworldEdge(0x25, "Main", "S", 1, 1, 1, false, 0.45);
    let edge1 = createOverworldEdge(0x28, "Bottom", "E", 1, 1, 1, false, 0.9);
    createOverworldEdge(0x68, "Top", "E", 0, 2, 2, false, 0.7);
    let edge2 = createOverworldEdge(0x68, "Bottom", "E", 2, 2, 2, false, 0.9);
    edge1.parallel = edge2;
    edge2.parallel = edge1;
    createDoubleOverworldEdge(0x29, "Top", "N", 1, 1, 1, false, 0.7);
    edge1 = createOverworldEdge(0x29, "Bottom", "W", 1, 1, 1, false, 0.9);
    createOverworldEdge(0x69, "Bottom", "W", 0, 2, 2, false, 0.7);
    edge2 = createOverworldEdge(0x69, "Bottom", "W", 2, 2, 2, false, 0.9);
    edge1.parallel = edge2;
    edge2.parallel = edge1;
    createDoubleOverworldEdge(0x29, "Bottom", "E", 1, 1, 1, false, 0.7);
    createDoubleOverworldEdge(0x2a, "Southwest", "W", 1, 1, 1, false, 0.7);
    createDoubleOverworldEdge(0x2a, "Southwest", "S", 0, 2, 2, false, 0.15);
    createDoubleOverworldEdge(0x2a, "Main", "S", 2, 2, 2, false, 0.45);
    createDoubleOverworldEdge(0x2b, "Main", "N", 1, 1, 1, false, 0.25);
    createDoubleOverworldEdge(0x2b, "Main", "E", 0, 3, 3, false, 0.35);
    createDoubleOverworldEdge(0x2b, "Main", "E", 1, 3, 3, false, 0.6);
    createDoubleOverworldEdge(0x2b, "Main", "E", 2, 3, 3, false, 0.8);
    createDoubleOverworldEdge(0x2b, "Main", "S", 1, 1, 1, false, 0.3);
    createDoubleOverworldEdge(0x2c, "Main", "N", 1, 1, 1, false, 0.6);
    createDoubleOverworldEdge(0x2c, "Main", "W", 0, 3, 3, false, 0.35);
    createDoubleOverworldEdge(0x2c, "Main", "W", 1, 3, 3, false, 0.6);
    createDoubleOverworldEdge(0x2c, "Main", "W", 2, 3, 3, false, 0.8);
    createDoubleOverworldEdge(0x2c, "Main", "S", 1, 1, 1, false, 0.45);
    createDoubleOverworldEdge(0x2c, "Main", "E", 1, 1, 1, false, 0.8);
    createDoubleOverworldEdge(0x2d, "North", "N", 1, 1, 1, false, 0.45);
    specialEdge = createOverworldEdge(0x2d, "River", "W", 0, 1, 1, true, 0.6);
    specialEdge.x = specialEdge.x2 = 0.65;
    edge1 = createOverworldEdge(0x2d, "South", "W", 2, 1, 1, false, 0.8);
    edge2 = createOverworldEdge(0x6d, "South", "W", 1, 1, 1, false, 0.8);
    edge1.parallel = edge2;
    edge2.parallel = edge1;
    createDoubleOverworldEdge(0x2d, "North", "E", 0, 1, 2, false, 0.3);
    createDoubleOverworldEdge(0x2d, "River", "E", 2, 1, 2, true, 0.65);
    createDoubleOverworldEdge(0x2d, "South", "S", 1, 1, 1, false, 0.45);
    createDoubleOverworldEdge(0x2e, "Main", "N", 1, 1, 1, false, 0.25);
    createDoubleOverworldEdge(0x2e, "Main", "W", 0, 1, 2, false, 0.3);
    createDoubleOverworldEdge(0x2e, "River", "W", 2, 1, 2, true, 0.65);
    createDoubleOverworldEdge(0x2e, "River", "S", 0, 1, 2, true, 0.6);
    createDoubleOverworldEdge(0x2e, "Main", "S", 2, 1, 2, false, 0.85);
    createDoubleOverworldEdge(0x2f, "Main", "N", 1, 1, 1, false, 0.75);
    createOverworldEdge(0x30, "Tablet", "E", 0, 2, 2, false, 1.5);
    createOverworldEdge(0x30, "Main", "E", 2, 2, 2, false, 1.8);
    createDoubleOverworldEdge(0x32, "Main", "N", 0, 2, 2, false, 0.15);
    createDoubleOverworldEdge(0x32, "North", "N", 2, 2, 2, false, 0.45);
    createDoubleOverworldEdge(0x32, "Main", "E", 1, 1, 1, false, 0.5);
    createDoubleOverworldEdge(0x33, "West", "N", 1, 1, 1, false, 0.3);
    createDoubleOverworldEdge(0x33, "West", "W", 1, 1, 1, false, 0.5);
    createDoubleOverworldEdge(0x33, "East", "E", 0, 2, 3, false, 0.3);
    createDoubleOverworldEdge(0x33, "East", "E", 1, 1, 3, true, 0.55);
    createDoubleOverworldEdge(0x33, "East", "E", 2, 2, 3, false, 0.8);
    createDoubleOverworldEdge(0x33, "East", "S", 1, 1, 1, false, 0.6);
    createWhirlpool(0x33, "East", 0.65, 0.6);
    createDoubleOverworldEdge(0x34, "Main", "N", 1, 1, 1, false, 0.45);
    createDoubleOverworldEdge(0x34, "Main", "W", 0, 2, 3, false, 0.3);
    createDoubleOverworldEdge(0x34, "Main", "W", 1, 1, 3, true, 0.55);
    createDoubleOverworldEdge(0x34, "Main", "W", 2, 2, 3, false, 0.8);
    createDoubleOverworldEdge(0x34, "Main", "S", 1, 1, 1, false, 0.5);
    createDoubleOverworldEdge(0x35, "Northwest", "N", 0, 1, 1, false, 0.45);
    ...
    createDoubleOverworldEdge(0x37, "Main", "S", 0, 1, 2, true, 0.25);
    createDoubleOverworldEdge(0x37, "Main", "S", 2, 1, 2, false, 0.65);
    createOverworldEdge(0x3a, "Ledge", "W", 0, 2, 2, false, 0.5);
    createOverworldEdge(0x3a, "Main", "W", 2, 2, 2, false, 0.8);
    createDoubleOverworldEdge(0x3a, "Main", "E", 0, 2, 2, false, 0.6);
    createDoubleOverworldEdge(0x3a, "Southeast", "E", 2, 2, 2, false, 0.85);
    createDoubleOverworldEdge(0x3b, "Main", "N", 1, 1, 1, false, 0.6);
    createDoubleOverworldEdge(0x3b, "Main", "W", 0, 2, 2, false, 0.6);
    createDoubleOverworldEdge(0x3b, "Main", "W", 2, 2, 2, false, 0.85);
    createDoubleOverworldEdge(0x3b, "Main", "E", 1, 1, 1, false, 0.5);
    createDoubleOverworldEdge(0x3c, "Main", "N", 1, 1, 1, false, 0.5);
    createDoubleOverworldEdge(0x3c, "Main", "W", 1, 1, 1, false, 0.5);
    createDoubleOverworldEdge(0x3c, "Main", "E", 1, 1, 1, false, 0.8);
    createDoubleOverworldEdge(0x3f, "Waterfall", "N", 0, 1, 2, true, 0.25);
    createDoubleOverworldEdge(0x3f, "Main", "N", 2, 1, 2, false, 0.65);
    createDoubleOverworldEdge(0x3f, "Main", "W", 0, 1, 2, true, 0.6);
    createDoubleOverworldEdge(0x3f, "Main", "W", 2, 1, 2, false, 0.85);
    createWhirlpool(0x3f, "Main", 0.25, 0.4);
    createWhirlpool(0x7f, "Main", 0.25, 0.4);
    createOverworldEdge(0x80, "Main", "S", 1, 1, 1, false, 0.45);
    createOverworldEdge(0x81, "Main", "S", 1, 1, 1, false, 0.5);
    createOverworldEdge(0x82, "Main", "E", 1, 1, 1, true, 0.6);
  ...
  window.getFixedEdgePairs = function () {
    ...
    if (layoutshuffle === "P") {
      if (!terrainow) fixedEdges.push(getEdgesByKeys(0x2d, "W0", 0x82, "E1"));
      if (similarow) {
        if (!terrainow) fixedEdges.push(getEdgesByKeys(0x1a, "E1", 0x1b, "W1"));
        fixedEdges.push(getEdgesByKeys(0x28, "E1", 0x29, "W1"));
        fixedEdges.push(getEdgesByKeys(0x68, "E0", 0x69, "W0"));
        fixedEdges.push(getEdgesByKeys(0x68, "E2", 0x69, "W2"));
        fixedEdges.push(getEdgesByKeys(0x30, "E0", 0x3a, "W0"));
        fixedEdges.push(getEdgesByKeys(0x30, "E2", 0x3a, "W2"));
      } else if (crossedow !== "C" && (!mixedow || crossedow === "P")) fixedEdges.push(getEdgesByKeys(0x68, "E0", 0x69, "W0"));
    }
  ...
  window.checkAutoAdjustments = function (makeAdjustments) {
    let info = {};
    let invalidScreensCount = 0,
      inconsistentGroupsCount = 0,
      missingScreensCount = 0,
      inconsistentSimilarCount = 0,
      inconsistentSwappedCount = 0,
      inconsistentParallelCount = 0,
      inconsistentCoupledCount = 0,
      invalidEdgesCount = 0,
      invalidIndegreeCount = 0,
      missingFixedCount = 0,
      missingSimilarCount = 0,
      missingSwappedCount = 0,
      missingParallelCount = 0,
      missingCoupledCount = 0;
    let inconsistentGroups = [],
      missingScreensNormal = [],
      missingScreensSwapped = [],
      invalidEdges = [],
      invalidIndegree = [],
      inconsistentEdges = [];
    if (mixedow) {
      if (worldState === "S")
        for (let id of [0x1b, 0x2b, 0x2c]) {
          if (makeAdjustments) setMixedScreen(overworldScreens.get(id), "normal");
          else {
            let group = getScreenLinkGroup(id, false);
            for (let i of group) if (overworldScreens.get(i).mixedState !== "normal") invalidScreensCount++;
          }
        }
      for (let id of overworldScreens.keys())
        if (id < 0x40 || id >= 0x80) {
          ...
          for (let i of group) {
            ...
            if (screen.mixedState === "unknown") isUnknown = true;
            if (screen.mixedState === "normal") isNormal = true;
            if (screen.mixedState === "flipped") isSwapped = true;
          }
      ...
      if (makeAdjustments) {
        for (let group of inconsistentGroups) setMixedScreen(overworldScreens.get(group[0]), "unknown");
        for (let group of missingScreensNormal) setMixedScreen(overworldScreens.get(group[0]), "normal");
        for (let group of missingScreensSwapped) setMixedScreen(overworldScreens.get(group[0]), "flipped");
      }
    }
      ...
      for (let edge of screen.edges.values())
        if (isShuffledEdge(edge)) {
          if (edge.out && !edgesCompatible(edge, edge.out)) {
            invalidEdgesCount++;
            if (makeAdjustments) deleteConnections(edge, true, false);
            else invalidEdges.push(edge);
          }
        }
    for (let screen of overworldScreens.values())
      for (let edge of screen.edges.values())
        if (isShuffledEdge(edge)) {
          if (decoupledow !== "C" && edge.in.length > 1) {
            ...
            if (makeAdjustments) for (let e in edge.in) deleteConnections(e, true, false);
          }
        }
    for (let screen of overworldScreens.values())
      for (let edge of screen.edges.values())
        if (isShuffledEdge(edge) && edge.out && (makeAdjustments || !invalidEdges.includes(edge))) {
          let edgeList1 = getSimilarGroup(edge),
            edgeList2 = getSimilarGroup(edge.out);
          let invalid = false;
          ...
          if (invalid)
            for (let e of edgeList1)
              if (e.out) {
                ...
                if (decoupledow === "N" && e.out.out === e) inconsistentEdges.push(e.out);
              }
        }
    for (let screen of overworldScreens.values())
      for (let edge of screen.edges.values())
        if (isShuffledEdge(edge) && edge.out && (makeAdjustments || !invalidEdges.includes(edge))) {
          ...
          if (invalid) {
            ...
            if (decoupledow === "N" && edge.out.out === edge) inconsistentEdges.push(edge.out);
            if (decoupledow === "N" && edge.vanilla.out.out === edge.vanilla) inconsistentEdges.push(edge.vanilla.out);
          }
        }
    for (let screen of overworldScreens.values())
      for (let edge of screen.edges.values())
        if (isShuffledEdge(edge) && edge.out && (makeAdjustments || !invalidEdges.includes(edge))) {
          ...
          if (invalid) {
            ...
            if (decoupledow === "N" && edge.out.out === edge) inconsistentEdges.push(edge.out);
            if (decoupledow === "N" && edge.parallel.out.out === edge.parallel) inconsistentEdges.push(edge.parallel.out);
          }
        }
    if (makeAdjustments) for (let edge of inconsistentEdges) deleteConnections(edge, true, false);
    for (let screen of overworldScreens.values())
      for (let edge of screen.edges.values())
        if (isShuffledEdge(edge) && edge.out && (makeAdjustments || !invalidEdges.includes(edge))) {
          let invalid = false;
          ...
          if (invalid) {
            ...
            if (makeAdjustments) deleteConnections(edge, true, true);
          }
        }
    for (let [edge1, edge2] of getFixedEdgePairs())
      if (edge1.out !== edge2 || edge2.out !== edge1) {
        missingFixedCount++;
        if (makeAdjustments) connectEdges(edge1, edge2, true, true);
      }
    for (let screen of overworldScreens.values())
      for (let edge of screen.edges.values())
        if (isShuffledEdge(edge) && edge.out && (makeAdjustments || (!invalidEdges.includes(edge) && !inconsistentEdges.includes(edge)))) {
          ...
          for (let e of edgeList) if (!e.out) missingSimilarCount++; //TODO not count inconsistent ones
          if (swappedow && !edge.vanilla.out) missingSwappedCount++;
          if ((layoutshuffle === "P" || (layoutshuffle === "N" && decoupledow !== "C")) && edge.parallel && edge.out.parallel && !edge.parallel.out) missingParallelCount++;
          if (decoupledow === "N" && !edge.in.length) missingCoupledCount++;
          if (makeAdjustments) connectSimilarSwappedParallel(edge, edge.out, decoupledow === "N", decoupledow !== "C");
        }
  ...
  window.vanillaHorizontal = function (button) {
    if (!button || confirm("Warning: This will replace all existing horizontal edge connections. Also, these changes cannot be undone without deleting each connection individually. Continue?")) {
      for (let screen of overworldScreens.values()) for (let edge of screen.edges.values()) if (edge.direction === "E") connectEdges(edge, edge.vanilla, true, true);
      if (button) {
        sendUpdate();
        updateReachableEdges();
        drawFullOverworldPanels();
  ...
  window.vanillaVertical = function (button) {
    if (!button || confirm("Warning: This will replace all existing vertical edge connections. Also, these changes cannot be undone without deleting each connection individually. Continue?")) {
      for (let screen of overworldScreens.values()) for (let edge of screen.edges.values()) if (edge.direction === "S") connectEdges(edge, edge.vanilla, true, true);
      if (button) {
        sendUpdate();
        updateReachableEdges();
        drawFullOverworldPanels();
  ...
  window.vanillaLight = function (button) {
    if (!button || confirm("Warning: This will replace all existing connections from Light World edges and whirlpools. Also, these changes cannot be undone without deleting each connection individually. Continue?")) {
      for (let screen of overworldScreens.values()) if (!screen.darkWorld) for (let edge of screen.edges.values()) if (edge.direction === "E" || edge.direction === "S" || edge.direction === "Z") connectEdges(edge, edge.vanilla, true, true);
      if (button) {
        sendUpdate();
        updateReachableEdges();
        drawFullOverworldPanels();
  ...
  window.vanillaSmallScreens = function (button) {
    if (
      !button ||
      confirm(
        "Warning: This will replace all existing connections from edges and whirlpools that connect two small screens in vanilla. Large screens include Kakariko, Hyrule Castle and Zora's Domain. Also, these changes cannot be undone without deleting each connection individually. Continue?"
      )
    ) {
      for (let screen of overworldScreens.values())
        for (let edge of screen.edges.values()) if ((edge.direction === "E" || edge.direction === "S" || edge.direction === "Z") && !edge.screen.bigInGame && !edge.vanilla.screen.bigInGame) connectEdges(edge, edge.vanilla, true, true);
      if (button) {
        sendUpdate();
        updateReachableEdges();
        drawFullOverworldPanels();
  ...
  window.vanillaLargeScreens = function (button) {
    if (
      !button ||
      confirm(
        "Warning: This will replace all existing connections from edges and whirlpools that touch at least one large screen in vanilla. Large screens include Kakariko, Hyrule Castle and Zora's Domain. Also, these changes cannot be undone without deleting each connection individually. Continue?"
      )
    ) {
      for (let screen of overworldScreens.values())
        for (let edge of screen.edges.values()) if ((edge.direction === "E" || edge.direction === "S" || edge.direction === "Z") && (edge.screen.bigInGame || edge.vanilla.screen.bigInGame)) connectEdges(edge, edge.vanilla, true, true);
  ...
  window.getSimilarGroup = function (edge) {
    let edgeList = [],
      edges = edge.screen.edges;
    if (similarow && (terrainow ? edge.similarGroupTerrain : edge.similarGroup) !== 1) {
      for (let k = 0; k < 3; k++) {
        if (edges.has(edge.direction + k) && (terrainow ? edges.get(edge.direction + k).similarGroupTerrain : edges.get(edge.direction + k).similarGroup) !== 1) edgeList.push(edges.get(edge.direction + k));
      }
  ...
  window.isDarkWorld = function (screen) {
    if (mixedow && screen.mixedState !== "unknown") return screen.darkWorld === (screen.mixedState === "normal");
  ...
  window.getConnectedEdge = function (edge, sources) {
    if (!isShuffledEdge(edge)) {
      if (mixedow && edge.parallel) {
        if (edge.screen.mixedState === "unknown" || edge.vanilla.screen.mixedState === "unknown") return sources ? [] : null;
        let r = crossedow === "P" || edge.screen.mixedState === edge.vanilla.screen.mixedState ? edge.vanilla : edge.parallel.vanilla;
        if (swappedow && crossedow === "C") r = r.parallel;
        return sources ? [r] : r;
      }
  ...
  window.getAssumedMixedState = function (screen, assumptions) {
    if (screen.mixedState !== "unknown") return screen.mixedState;
  ...
  window.isAssumedDarkWorld = function (screen, assumptions) {
    if (mixedow) {
      ...
      if (state !== "unknown") return screen.darkWorld === (state === "normal");
    }
    return screen.darkWorld;
  };
  ...
  window.getAssumedConnectedEdge = function (edge, sources, assumptions) {
    if (!isShuffledEdge(edge)) {
      if (mixedow && edge.parallel) {
        if (getAssumedMixedState(edge.screen, assumptions) === "unknown" || getAssumedMixedState(edge.vanilla.screen, assumptions) === "unknown") return sources ? [] : null;
  ...
  window.addContinueRegion = function (id, state, normalRegion, swappedRegion, checkableScreens, continueRegions) {
    ...
    if (state !== "unknown") {
      ...
      if (!continueRegions.has(keyNormal)) continueRegions.set(keyNormal, new Set());
      if (!continueRegions.has(keySwapped)) continueRegions.set(keySwapped, new Set());
  ...
  window.explore = function (current, items, options, visitedRegions, visitedScreenEdges, checkableScreens, continueRegions, assumptions) {
    ...
    if ((worldState === "I") === (darkWorld === current.darkWorld)) edgesOut = edgesOut.concat(current.invertedLogicEdgesOut);
    else if (current.openLogicEdgesOut) edgesOut = edgesOut.concat(current.openLogicEdgesOut);
    ...
    for (let edge of edgesOut) {
      if ((!edge.rule || checkRule(edge.rule, items, options, darkWorld)) && !visitedRegions.has(edge.target)) {
        if (mixedow && getAssumedMixedState(edge.target.screen, assumptions) === "unknown") checkableScreens.add(edge.target.screen.id & 0xbf);
        else explore(edge.target, items, options, visitedRegions, visitedScreenEdges, checkableScreens, continueRegions, assumptions);
      }
    }
    ...
    if (options.fluteEdges && items.flute >= 1 && current.parallel && !current.mirrorBlock && darkWorld === (worldState === "I")) {
      for (let region of fluteSpotRegions)
        if ((!mixedow || region.screen.mixedState !== "unknown") && !visitedRegions.has(region)) explore(region, items, options, visitedRegions, visitedScreenEdges, checkableScreens, continueRegions, assumptions);
    }
  ...
  window.dijkstra = function (goal, items, options) {
    ...
    while (reachable.size != 0) {
      ...
      if ((worldState === "I") === (darkWorld === current.darkWorld)) edgesIn = edgesIn.concat(current.invertedLogicEdgesIn);
      else if (current.openLogicEdgesIn) edgesIn = edgesIn.concat(current.openLogicEdgesIn);
      if (!options.follower || ((options.follower === "smithfrog" || options.follower === "smithfrognosq") && entranceEnabled)) {
  ...
  window.canReachFrom = function (start, target, items, follower, availability, mirrorStart, mirrorTarget) {
    ...
    if (items.lantern || normal === "available" || normal === "darkavailable") return normal;
    let dark = singleLogicCanReachFrom(start, target, items, follower, true, availability, mirrorStart, mirrorTarget);
    if (dark === "available" || dark === "possible") dark = "dark" + dark;
    if (normal === "unavailable") return dark;
  ...
  window.singleLogicCanReachFrom = function (start, target, items, follower, darkRoomNavigation, availability, mirrorStart, mirrorTarget) {
    ...
    if (!entranceEnabled && mixedow && layoutshuffle === "N" && crossedow !== "C") {
      ...
      for (let id of unimportantScreens) assumptions.set(id, "normal");
    }
    ...
    if (items.mirror) {
      if (mirrorStart !== "unavailable") {
        ...
        if (reachable.has(target)) availability = mirrorStart;
      }
    ...
    switch (rule) {
      ...
      case "trmedallionmaybe":
        ...
        if ((items.moonpearl || darkWorld === (worldState === "I")) && (items.sword > 0 || (items.flags && items.flags.swordmode === "S"))) {
          if (items.bombos && items.ether && items.quake) return true;
        ...
        return false;
      case "greenpendant":
        if (items.prizes) for (let k = 0; k < 10; k++) if (items.prizes[k] === 1 && items["boss" + k]) return true;
        return false;
      case "allpendants":
        if (items.prizes) {
          let c = 0;
          for (let k = 0; k < 10; k++) if ((items.prizes[k] === 1 || items.prizes[k] === 2) && items["boss" + k]) if (++c === 3) return true;
        }
        return false;
      case "redcrystals":
        if (items.prizes) {
          let c = 0;
          for (let k = 0; k < 10; k++) if (items.prizes[k] === 4 && items["boss" + k]) if (++c === 2) return true;
        }
        return false;
      case "gtcrystals":
      case "gtcrystalsmaybe":
        if (items.prizes) {
          let goal = 7;
          if (items.flags && Number.isInteger(items.flags.opentowercount) && items.flags.opentowercount < 7) goal = items.flags.opentowercount;
          if (items.flags.opentowercount === 8 && rule.endsWith("maybe")) return true;
          if (goal <= 0) return true;
          let c = 0;
          for (let k = 0; k < 10; k++) if ((items.prizes[k] === 3 || items.prizes[k] === 4) && items["boss" + k]) if (++c === goal) return true;
        }
        return false;
      default:
  ...
  window.setUnion = function (set1, set2) {
    if (!set1) return set2 ? set2 : new Set();
    if (!set2) return set1;
    let set = new Set(set1);
    for (let r of set2) set.add(r);
    return set;
  };
  ...
  window.determineOverworldAvailability = function (items, startRegions, checkableScreens, continueRegions) {
    let visitedRegions = new Set(),
      visitedScreenEdges = new Set();
    let checkableScreensDarkRooms = new Set(checkableScreens),
      continueRegionsDarkRooms = new Map(continueRegions);
    let options = {};
    for (let start of startRegions) if (!visitedRegions.has(start) && (!mixedow || start.screen.mixedState !== "unknown")) explore(start, items, options, visitedRegions, visitedScreenEdges, checkableScreens, continueRegions, emptyMap);
    ...
    if (!items.lantern) {
      let visitedRegionsDarkRooms = new Set(),
        visitedScreenEdgesDarkRooms = new Set();
  ...
  window.determineCheckableScreens = function (items, options, visitedRegions, visitedScreenEdges, checkableScreens, continueRegions) {
    ...
    let maybeVisitedRegions = new Set(),
      extraVisitedRegions = new Set(),
      maybeLightRegions = new Set(),
    ...
    if (mixedow && checkableScreens.size != 0) {
      ...
      while (nextScreens.size != 0) {
        ...
        nextScreens = new Set();
        for (let id of cs) {
          if (assumedScreens.has(id)) continue;
          let assumptions = new Map();
          let regionsAssumeNormal = new Set(visitedRegions),
            regionsAssumeSwapped = new Set(visitedRegions);
          ...
          let continueAssumeNormal = new Map(),
            continueAssumeSwapped = new Map();
          let group = getScreenLinkGroup(id, false);
          for (let n of group) assumedScreens.add(n);
          for (let n of group) assumptions.set(n, "normal");
          for (let n of group) if (cr.has(n + " normal")) for (let start of cr.get(n + " normal")) explore(start, items, options, regionsAssumeNormal, edgesAssumeNormal, checkableAssumeNormal, continueAssumeNormal, assumptions);
          for (let n of group) assumptions.set(n, "flipped");
          for (let n of group) if (cr.has(n + " swapped")) for (let start of cr.get(n + " swapped")) explore(start, items, options, regionsAssumeSwapped, edgesAssumeSwapped, checkableAssumeSwapped, continueAssumeSwapped, assumptions);
          ...
          if (!maybeMode)
            for (let c of commonCheckable) {
              nextScreens.add(c);
              if (!cr.has(c + " normal")) cr.set(c + " normal", new Set());
              if (!cr.has(c + " swapped")) cr.set(c + " swapped", new Set());
              let crNormal = cr.get(c + " normal"),
                crSwapped = cr.get(c + " swapped");
              let normalSize = crNormal.size,
                swappedSize = crSwapped.size;
              let commonNormal = setIntersection(continueAssumeNormal.get(c + " normal"), continueAssumeSwapped.get(c + " normal"));
              for (let region of commonNormal) crNormal.add(region);
              let commonSwapped = setIntersection(continueAssumeNormal.get(c + " swapped"), continueAssumeSwapped.get(c + " swapped"));
              for (let region of commonSwapped) crSwapped.add(region);
              if (crNormal.size != normalSize || crSwapped.size != swappedSize) assumedScreens.delete(c);
            }
          for (let c of maybeCheckable) {
            (maybeMode ? nextScreens : maybeCheckableScreens).add(c);
            if (!mcr.has(c + " normal")) mcr.set(c + " normal", new Set());
            if (!mcr.has(c + " swapped")) mcr.set(c + " swapped", new Set());
            let crNormal = mcr.get(c + " normal"),
              crSwapped = mcr.get(c + " swapped");
            let normalSize = crNormal.size,
              swappedSize = crSwapped.size;
        ...
        if (nextScreens.size == 0) {
          if (maybeMode) {
            for (let n of assumedScreens) maybeCheckableScreens.add(n);
          } else {
            for (let n of assumedScreens) checkableScreens.add(n);
  ...
  window.determineLocationAvailability = function (items, r) {
    let regions = r.visitedRegions
    let maybeLightRegions = r.maybeLightRegions
    let maybeDarkRegions = r.maybeDarkRegions
    let door = items.flags && items.flags.doorshuffle ? items.flags.doorshuffle !== "N" : doorshuffle !== "N"
    let data = {}
    data.logic = true
    data.items = new Array(120)
    for (let k = 0; k < 120; k++) data.items[k] = "unavailable"
    data.entranceitems = []
    data.dungeons = new Array(104)
    for (let k = 0; k < 104; k++) data.dungeons[k] = "unavailable"
    data.entrances = new Array(140)
    for (let k = 0; k < 140; k++) data.entrances[k] = "unavailable"
    data.dungeonsBunny = {}
    data.special = {}
    let options = {},
      optionsDarkRooms = {};
    optionsDarkRooms.darkRoomNavigation = true;
    let extraRegions = new Set(),
      extraRegionsDarkRooms = new Set();
    //Collect all points of interest in reachable regions
    //Always reachable regions with known state
    for (let region of regions) {
      if (mixedow && region.screen.mixedState === "unknown") extraRegions.add(region);
      else {
        ...
        for (let location of region.locations) {
          ...
          if (!items.moonpearl && location.type === "dungeons") data.dungeonsBunny[location.id] = darkWorld !== (worldState === "I");
        }
      }
    }
    //Always reachable regions with known state if going through dark rooms
    for (let region of r.visitedRegionsDarkRooms) {
      if (mixedow && region.screen.mixedState === "unknown") extraRegionsDarkRooms.add(region);
      else {
      ...
      for (let location of region.locations) {
        if (data[location.type][location.id] !== "available" && region.screen.mixedState === "unknown") {
          if (!location.rule || (checkRule(location.rule, items, options, true) && checkRule(location.rule, items, options, false))) {
            data[location.type][location.id] = "available";
          } else if (data[location.type][location.id] !== "darkavailable" && (checkRule(location.rule, items, options, true) || checkRule(location.rule, items, options, false))) data[location.type][location.id] = "possible";
          if (!items.moonpearl && location.type === "dungeons") data.dungeonsBunny[location.id] = data[location.type][location.id] === "available";
        }
      }
    }
    ...
    for (let region of extraRegionsDarkRooms) {
      ...
      for (let location of region.locations) {
        if (data[location.type][location.id] !== "available" && data[location.type][location.id] !== "darkavailable" && region.screen.mixedState === "unknown") {
          ...
          if (!items.moonpearl && location.type === "dungeons") data.dungeonsBunny[location.id] = data[location.type][location.id] === "available" || data[location.type][location.id] === "darkavailable";
        }
      }
    }
      ...
      for (let region of maybeLightRegions) {
        for (let location of region.locations) {
          if (data[location.type][location.id] !== "available" && data[location.type][location.id] !== "darkavailable" && data[location.type][location.id] !== "possible") {
            ...
            if (!items.moonpearl && location.type === "dungeons") data.dungeonsBunny[location.id] = worldState === "I";
          }
        }
      }
    ...
    if (mixedow) {
      if (
        (overworldScreens.get(0x1b).mixedState !== "unknown" && (overworldScreens.get(0x1b).mixedState === "flipped") === (worldState === "I")) ||
        (overworldScreens.get(0x03).mixedState !== "unknown" && (overworldScreens.get(0x03).mixedState === "flipped") === (worldState === "I"))
      )
        towerSwap = false;
      else if (
        overworldScreens.get(0x1b).mixedState !== "unknown" &&
        (overworldScreens.get(0x1b).mixedState === "flipped") !== (worldState === "I") &&
        overworldScreens.get(0x03).mixedState !== "unknown" &&
        (overworldScreens.get(0x03).mixedState === "flipped") !== (worldState === "I")
      )
        towerSwap = true;
      if (overworldScreens.get(0x1b).mixedState !== "unknown") ganonSwap = (overworldScreens.get(0x1b).mixedState === "flipped") !== (worldState === "I");
    } else towerSwap = ganonSwap = worldState === "I";
    if (towerSwap === true) {
    ...
    if (towerSwap === "unknown") {
      ...
      if (data.dungeonsBunny[80] !== data.dungeonsBunny[96]) data.dungeonsBunny[80] = data.dungeonsBunny[96] = false;
    }
    if (ganonSwap === true) {
      ...
      if ((mixedow && overworldScreens.get(0x03).mixedState === "unknown") || (mixedow && overworldScreens.get(0x03).mixedState === "flipped") !== (worldState === "I")) {
        if (items.lantern) {
          if (data.items[75] !== "unavailable") {
            ...
            if (data.items[75] === "unavailable") data.items[75] = "possible";
          }
        } else {
          if (data.special["Old Man Dark Room"]) {
            ...
            if (data.items[75] === "unavailable") data.items[75] = "darkpossible";
            if (data.items[75] === "available" || data.items[75] === "possible") data.items[75] = "dark" + data.items[75];
          }
        }
      } else {
        if (items.lantern) {
    ...
    if (!items.lantern && data.special["Dark Cross Dark Room"]) {
      ...
      if (data.items[104] === "available" || data.items[104] === "possible") data.items[104] = "dark" + data.items[104];
    }
    if (!entranceEnabled && !door) andSpecial(data.dungeons, 73, data.special["Dam"]);
    ...
    for (let k = 0; k < 64; k++) data.entranceitems[k] = data.items[entranceItemToItem[k]];
    //Red bomb
    ...
    if (data.items[101] !== "unavailable") {
      ...
      if (data.items[101] === "available" || data.items[101] === "darkavailable") {
        ...
        if (data.items[101] !== direct) data.items[101] = direct === "darkavailable" ? "darkavailable" : "possible";
      }
    }
    //Purple chest
    ...
    if (data.entranceitems[0] === "available") data.entranceitems[0] = "possible";
    if (data.entranceitems[0] === "darkavailable") data.entranceitems[0] = "darkpossible";
    if (data.entrances[94] === "available") data.entrances[94] = "possible";
    if (data.entrances[94] === "darkavailable") data.entrances[94] = "darkpossible";
    //Manually refine access to certain items that involve dungeons
    if (!entranceEnabled) {
      let front = data.items[104],
        back = data.items[96];
      let retro = items.flags && items.flags.gametype ? items.flags.gametype === "R" : worldState === "R";
      //Back of Escape
      if (back !== "unavailable") data.items[96] = bestAvailability(data.items[96], items.bomb || items.boots ? back : "unavailable");
        ...
        if (retro || (items.flags && items.flags.wildkeys)) data.items[96] = bestAvailability(data.items[96], retro || items.smallkey11 ? (items.lantern ? front : front.startsWith("dark") ? front : "dark" + front) : "unavailable");
        else data.items[96] = bestAvailability(data.items[96], items.lantern ? "possible" : "darkpossible");
      }
      //Sewers
      if (front !== "available" && back !== "unavailable" && (items.bomb || items.sword || items.bow > 1 || items.hammer || items.firerod || items.somaria || items.byrna)) {
        if (retro || (items.flags && items.flags.wildkeys)) data.items[104] = bestAvailability(data.items[104], retro || items.smallkey11 ? (items.lantern ? back : back.startsWith("dark") ? back : "dark" + back) : "unavailable");
        else data.items[104] = bestAvailability(data.items[104], items.lantern ? "possible" : "darkpossible");
      }
      //Castle Tower
      andSpecial(data.items, 107, data.items[106]);
      if (data.items[107] === "unavailable") data.items[106] = "unavailable";
      else {
      ...
      if (data.items[89] === "information" || data.items[89] === "unavailable")
        if (door) {
          if (data.special["Check Desert"] && items.book) {
            ...
            if (data.special["Desert Access"] && (!mixedow || overworldScreens.get(0x30).mixedState !== "unknown") && (mixedow && overworldScreens.get(0x30).mixedState === "flipped") !== (worldState === "I")) data.helpDesert = true;
          }
        } else if (data.special["Desert Access"]) data.items[89] = data.special["Desert Access"];
      //Mimic Cave
      if (
        items.mirror &&
        items.hammer &&
        items.moonpearl &&
        data.items[4] === "unavailable" &&
        data.entrances[136] !== "unavailable" &&
        (!mixedow || overworldScreens.get(0x1b).mixedState !== "unknown") &&
        (mixedow && overworldScreens.get(0x05).mixedState === "flipped") === (worldState === "I")
      )
        if (door) {
          data.items[4] = data.entrances[136].startsWith("dark") ? "darkpossible" : "possible";
          if (data.entrances[136] === "available" || data.entrances[136] === "darkavailable") data.helpMimic = true;
        } else if (items.somaria && items.bomb)
          if (retro || (items.flags && items.flags.wildkeys)) data.items[4] = retro || items.smallkey9 > 1 ? data.entrances[136] : "unavailable";
          else data.items[4] = items.firerod ? data.entrances[136] : data.entrances[136].startsWith("dark") ? "darkpossible" : "possible";
      ...
      if (door) {
        ...
        if ((!mixedow || overworldScreens.get(0x30).mixedState !== "unknown") && (mixedow && overworldScreens.get(0x30).mixedState === "flipped") !== (worldState === "I")) {
          if (data.dungeons[8] !== "unavailable") {
            ...
            if (items.gloves && items.moonpearl) data.dungeons[11] = data.dungeons[8];
          }
        }
        ...
        if ((!mixedow || overworldScreens.get(0x00).mixedState !== "unknown") && (mixedow && overworldScreens.get(0x00).mixedState === "flipped") === (worldState === "I")) {
          ...
          if (items.firerod) data.dungeons[43] = bestAvailability(data.dungeons[42], data.dungeons[43]);
        }
        //Turtle Rock
        if ((!mixedow || overworldScreens.get(0x05).mixedState !== "unknown") && (mixedow && overworldScreens.get(0x05).mixedState === "flipped") === (worldState === "I")) {
          if (data.dungeons[72] !== "unavailable" && items.bomb) data.dungeons[73] = data.dungeons[74] = bestAvailability(data.dungeons[72], data.dungeons[73], data.dungeons[74]);
        ...
        if (towerSwap !== false) {
          if (data.dungeons[80] === "unavailable" && (!mixedow || overworldScreens.get(0x1b).mixedState !== "unknown")) {
            ...
            if (entrycheck !== "unavailable" && (data.dungeons[88] !== "unavailable" || data.dungeons[91] !== "unavailable" || data.dungeons[92] !== "unavailable")) {
              ...
              if (towerSwap !== "unknown") data.dungeonsBunny[80] = data.dungeonsBunny[88];
            }
          }
        }
        if (towerSwap !== false) {
          if (data.dungeons[80] === "unavailable" && (!mixedow || overworldScreens.get(0x1b).mixedState !== "unknown")) {
            let entrycheck = checkRule("gtcrystals", items, options, isDarkWorld(overworldScreens.get(0x1b)))
              ? "available"
              : checkRule("gtcrystalsmaybe", items, options, isDarkWorld(overworldScreens.get(0x1b)))
              ? "possible"
              : "unavailable";
            if (entrycheck !== "unavailable" && (data.dungeons[88] !== "unavailable" || data.dungeons[91] !== "unavailable" || data.dungeons[92] !== "unavailable")) {
    ...
    if (data.entrances[102] !== "unavailable" && !data.dungeonsBunny[40]) {
      if (items.firerod && data.entrances[96] === "unavailable") data.entrances[96] = door ? (data.entrances[102].startsWith("dark") ? "darkpossible" : "possible") : data.entrances[102];
      if (data.entrances[97] === "unavailable") data.entrances[97] = door ? (data.entrances[102].startsWith("dark") ? "darkpossible" : "possible") : data.entrances[102];
      if (data.entrances[98] === "unavailable") data.entrances[98] = door ? (data.entrances[102].startsWith("dark") ? "darkpossible" : "possible") : data.entrances[102];
    }
    data.special = null;
  ...
  window.orSpecial2 = function (base, special, availability) {
    if (base === "available" || special === "unavailable" || !special || base === availability) return base;
    if (base === "unavailable" && special === "available") return availability;
    if (base === "unavailable" && special === "darkavailable" && (availability === "darkavailable" || availability === "darkpossible" || availability === "information")) return availability;
    if (base === "unavailable" && special === "darkavailable" && (availability === "available" || availability === "possible")) return "dark" + availability;
    if (base === "unavailable" && special === "possible" && (availability === "available" || availability === "possible")) return "possible";
    if (base === "unavailable" && special === "possible" && (availability === "darkavailable" || availability === "darkpossible")) return "darkpossible";
    if (base === "unavailable" && special === "darkpossible" && (availability === "available" || availability === "possible" || availability === "darkavailable" || availability === "darkpossible")) return "darkpossible";
    if (base === "darkpossible" && special === "available" && (availability === "available" || availability === "possible" || availability === "darkavailable")) return availability;
    if (base === "darkpossible" && special === "darkavailable" && (availability === "available" || availability === "darkavailable")) return "darkavailable";
    if (base === "darkpossible" && special === "possible" && (availability === "available" || availability === "possible")) return "possible";
    if (base === "possible" && special === "available" && (availability === "available" || availability === "darkavailable")) return availability;
    if (base === "possible" && special === "darkavailable" && (availability === "available" || availability === "darkavailable")) return "darkavailable";
    if (base === "darkavailable" && special === "available" && availability === "available") return availability;
    return base;
  };

  window.andSpecial = function (object, locationID, special) {
    if (object[locationID] !== special)
      if ((object[locationID] === "available" && special === "partialavailable") || (object[locationID] === "partialavailable" && special === "available")) object[locationID] = "partialavailable";
        ...
        special === "partialavailable" ||
        object[locationID] === "information" ||
        special === "information"
      )
        object[locationID] = "unavailable";
      else if (object[locationID] === "darkpossible" || special === "darkpossible") object[locationID] = "darkpossible";
      else if ((object[locationID] === "possible" && special === "darkavailable") || (object[locationID] === "darkavailable" && special === "possible")) object[locationID] = "darkpossible";
      else if (object[locationID] === "possible" || special === "possible") object[locationID] = "possible";
      else if (object[locationID] === "darkavailable" || special === "darkavailable") object[locationID] = "darkavailable";
    //else
  ...
  window.twoOptions = function (option1, option2) {
    ...
    if (option1 === "available" && option2 === "darkavailable") return "darkavailable";
    if (option1 === "darkavailable" && option2 === "available") return "darkavailable";
    if (option1 === "possible" && option2 === "darkpossible") return "darkpossible";
    if (option1 === "darkpossible" && option2 === "possible") return "darkpossible";
    if (option1 === "darkavailable" && option2 === "darkpossible") return "darkpossible";
    if (option1 === "darkpossible" && option2 === "darkavailable") return "darkpossible";
    return "possible";
  };

  window.bestAvailability = function (...availabilityList) {
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "available") return "available";
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "darkavailable") return "darkavailable";
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "possible") return "possible";
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "darkpossible") return "darkpossible";
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "partialavailable") return "partialavailable";
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "information") return "information";
    return "unavailable";
  };

  window.worstAvailability = function (...availabilityList) {
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "unavailable") return "unavailable";
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "information") return "information";
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "partialavailable") return "partialavailable";
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "darkpossible") return "darkpossible";
    for (let k = 0; k < availabilityList.length; k++) if (availabilityList[k] === "possible") return "possible";
  ...
  window.canPlaceMirrorPortal = function (region, r) {
    if ((mixedow && region.screen.mixedState === "unknown") || isDarkWorld(region.screen) !== (worldState === "I") || !region.parallel || region.parallel.mirrorBlock) return "unavailable";
    if (r.visitedRegions.has(region.parallel)) return "available";
  ...
  window.createItemLocation = function (screenID, regionName, locationID, entranceLocationID, rule) {
    ...
    if (entranceLocationID != -1) entranceItemToItem[entranceLocationID] = locationID;
  };
  ...
  window.setEntranceRegion = function (screenID, regionName, entranceIndices) {
    let screen = overworldScreens.get(screenID),
      region = screen.regions.get(regionName);
    screen.entranceRegions.push(region);
    region.numberEntrances = entranceIndices.length;
    for (let k of entranceIndices) entranceIndexToRegion[k] = region;
  };
  ...
  window.getEntranceRegionFromIndex = function (index) {
    ...
    if ((index === 93 || index === 95) && (worldState === "I") !== (mixedow && overworldScreens.get(0x1b).mixedState === "flipped")) index += 200;
  ...
  window.createDefaultConnector = function (screenID1, regionName1, screenID2, regionName2, rule, bidirectional) {
    let edge = {},
      screen1 = overworldScreens.get(screenID1),
      screen2 = overworldScreens.get(screenID2);
    let region1 = screen1.regions.get(regionName1),
      region2 = screen2.regions.get(regionName2);
    edge.source = region1;
    edge.target = region2;
    edge.rule = rule;
    edge.weight = 3;
  ...
  window.createSpecialDefaultConnector = function (screenID1, regionName1, world1, screenID2, regionName2, world2, rule, bidirectional) {
    ...
    edge.rule = rule;
    edge.weight = 3;
    if (!region1.specialDefaultConnectorsOut) region1.specialDefaultConnectorsOut = [];
    if (!region2.specialDefaultConnectorsIn) region2.specialDefaultConnectorsIn = [];
    ...
    if (bidirectional) {
      ...
      edge.rule = rule;
      edge.weight = 3;
      if (!region1.specialDefaultConnectorsIn) region1.specialDefaultConnectorsIn = [];
      if (!region2.specialDefaultConnectorsOut) region2.specialDefaultConnectorsOut = [];
  ...
  window.createSingleLogicEdge = function (screenID, regionName1, regionName2, rule, bidirectional) {
    let edge = {},
      screen = overworldScreens.get(screenID);
    let region1 = screen.regions.get(regionName1),
      region2 = screen.regions.get(regionName2);
    edge.source = region1;
    edge.target = region2;
    edge.rule = rule;
    edge.weight = 0.1;
  ...
  window.createOpenLogicEdge = function (screenID, regionName1, regionName2, rule, bidirectional) {
    ...
    edge.rule = rule;
    edge.weight = 0.1;
    if (!region1.openLogicEdgesOut) region1.openLogicEdgesOut = [];
    if (!region2.openLogicEdgesIn) region2.openLogicEdgesIn = [];
    ...
    if (bidirectional) {
      ...
      edge.rule = rule;
      edge.weight = 0.1;
      if (!region1.openLogicEdgesIn) region1.openLogicEdgesIn = [];
      if (!region2.openLogicEdgesOut) region2.openLogicEdgesOut = [];
  ...
  window.setRandomizerNames = function (screenID, name, north, west, east, south) {
    ...
    for (let edge of screen.edges.values()) {
      if (edge.direction === "Z") {
        let baseName = name;
        if (baseName.endsWith(" Waterfall") || baseName.endsWith(" Whirlpool")) baseName = baseName.substring(0, baseName.length - 10);
  ...
  window.createOverworldEdge = function (screenID, regionName, direction, symbol, similarGroup, similarGroupTerrain, water, position) {
    ...
    switch (edge.direction) {
      case "N":
        ...
        edge.y = 0.125;
        edge.y2 = screen.big ? 0.25 : 0.125;
        break;
      case "S":
        edge.x = edge.x2 = position;
        edge.y = screen.big ? 1.875 : 0.875;
        edge.y2 = screen.big ? 1.75 : 0.875;
        break;
      case "W":
        edge.x = 0.125;
        edge.x2 = screen.big ? 0.25 : 0.125;
        edge.y = edge.y2 = position;
        break;
      case "E":
        edge.x = screen.big ? 1.875 : 0.875;
        edge.x2 = screen.big ? 1.75 : 0.875;
        edge.y = edge.y2 = position;
    }
    edge.out = null;
    edge.in = [];
  ...
  window.createDoubleOverworldScreen = function (screenID, nameLight, nameDark, big, regionNames, fluteRegionName) {
    if (!regionNames) regionNames = ["Main"];
    ...
    for (let regionName of regionNames) {
      let region1 = screen1.regions.get(regionName),
        region2 = screen2.regions.get(regionName);
  ...
  window.getNiceEdgeName = function (edge) {
    if (edge.string === "ZW") return edge.screen.name + " Whirlpool";
  ...
  window.connectEdges = function (edge1, edge2, bidirectional, indegreeOne) {
    ...
    if (indegreeOne && edge2.in.length) {
      for (let e of edge2.in) e.out = null;
      edge2.in = [];
    }
    ...
    if (bidirectional && indegreeOne && edge1.in.length) {
      for (let e of edge1.in) e.out = null;
      edge1.in = [];
    }
  ...
  window.edgesCompatible = function (edge1, edge2) {
    return (
      edge1.direction === opposite[edge2.direction] &&
      (terrainow || edge1.water === edge2.water) &&
      (worldState !== "S" || crossedow === "C" || mixedow || edge1.escapeEdge === edge2.escapeEdge) &&
      maybeCompatibleWorlds(edge1.screen, edge2.screen) &&
      compatibleParallel(edge1, edge2) &&
      compatibleSimilar(edge1, edge2)
    );
  };
  ...
  window.compatibleSimilar = function (edge1, edge2) {
    if (!similarow) return true;
    if ((!terrainow && edge1.water) || edge1.string === "ZW") return true;
    if (terrainow ? edge1.similarGroupTerrain !== edge2.similarGroupTerrain : edge1.similarGroup !== edge2.similarGroup) return false;
  ...
  window.firstInSimilarPair = function (edge) {
    ...
    for (let k = 0; k < 3; k++) if (edges.has(edge.direction + k) && (terrainow ? edges.get(edge.direction + k).similarGroupTerrain : edges.get(edge.direction + k).similarGroup) === 2) return k === edge.symbol;
  };
  ...
  window.connectSimilarSwappedParallel = function (edge1, edge2, bidirectional, indegreeOne) {
    if (similarow && (terrainow ? edge1.similarGroupTerrain !== 1 && edge1.similarGroupTerrain === edge2.similarGroupTerrain : edge1.similarGroup !== 1 && edge1.similarGroup === edge2.similarGroup)) {
      let edges1 = edge1.screen.edges,
        edges2 = edge2.screen.edges;
      if ((terrainow ? edge1.similarGroupTerrain : edge1.similarGroup) === 3) for (let k = 0; k < 3; k++) connectSwappedParallel(edges1.get(edge1.direction + k), edges2.get(edge2.direction + k), bidirectional, indegreeOne);
      else {
        let edgeList1 = [],
          edgeList2 = [];
        for (let k = 0; k < 3; k++) {
          if (edges1.has(edge1.direction + k) && (terrainow ? edges1.get(edge1.direction + k).similarGroupTerrain : edges1.get(edge1.direction + k).similarGroup) === 2) edgeList1.push(edges1.get(edge1.direction + k));
          if (edges2.has(edge2.direction + k) && (terrainow ? edges2.get(edge2.direction + k).similarGroupTerrain : edges2.get(edge2.direction + k).similarGroup) === 2) edgeList2.push(edges2.get(edge2.direction + k));
        }
    ...
    } else connectSwappedParallel(edge1, edge2, bidirectional, indegreeOne);
  };
  ...
  window.connectSwappedParallel = function (edge1, edge2, bidirectional, indegreeOne) {
    ...
    if (swappedow && edge1 != edge2 && edge1.vanilla != edge2) connectParallel(edge1.vanilla, edge2.vanilla, bidirectional, indegreeOne);
  };

  window.connectParallel = function (edge1, edge2, bidirectional, indegreeOne) {
    connectEdges(edge1, edge2, bidirectional, indegreeOne);
    if ((layoutshuffle === "P" || (layoutshuffle === "N" && decoupledow !== "C")) && edge1.parallel && edge2.parallel) connectEdges(edge1.parallel, edge2.parallel, bidirectional, indegreeOne);
  };
  ...
  window.deleteConnections = function (edge, deleteOut, deleteIn) {
    ...
    if (deleteIn && edge.in.length) {
      for (let e of edge.in) e.out = null;
      edge.in = [];
    }
  };
  ...
  window.deleteSimilarSwappedParallel = function (edge, deleteOut, deleteIn) {
    if (similarow && (terrainow ? edge.similarGroupTerrain : edge.similarGroup) !== 1) {
      let edges = edge.screen.edges;
      if ((terrainow ? edge.similarGroupTerrain : edge.similarGroup) === 3) for (let k = 0; k < 3; k++) deleteSwappedParallel(edges.get(edge.direction + k), deleteOut, deleteIn);
      else
        for (let k = 0; k < 3; k++)
          if (edges.has(edge.direction + k) && (terrainow ? edges.get(edge.direction + k).similarGroupTerrain : edges.get(edge.direction + k).similarGroup) === 2) deleteSwappedParallel(edges.get(edge.direction + k), deleteOut, deleteIn);
    } else deleteSwappedParallel(edge, deleteOut, deleteIn);
  };

  window.deleteSwappedParallel = function (edge, deleteOut, deleteIn) {
    deleteParallel(edge, deleteOut, deleteIn);
    if (swappedow) deleteParallel(edge.vanilla, deleteOut, deleteIn);
  };

  window.deleteParallel = function (edge, deleteOut, deleteIn) {
    deleteConnections(edge, deleteOut, deleteIn);
    if ((layoutshuffle === "P" || (layoutshuffle === "N" && decoupledow !== "C")) && edge.parallel) deleteConnections(edge.parallel, deleteOut, deleteIn);
  };
  ...
  window.getScreenLinks = function () {
    ...
    if (layoutshuffle === "N" && crossedow === "N") screenLinks = screenLinks.concat(screenLinksLayout);
    if (!whirlpoolshuffle && crossedow === "N") screenLinks = screenLinks.concat(screenLinksWhirlpool);
    if (!entranceEnabled) screenLinks = screenLinks.concat(screenLinksEntrance);
    return screenLinks;
  };
  ...
  window.setMixedScreen = function (screen, state) {
    ...
    if (layoutshuffle === "N" && crossedow === "N" && !whirlpoolshuffle && [0x35, 0x81].includes(id)) id = 0x0f;
    if (layoutshuffle === "N" && crossedow === "N" && !entranceEnabled && [0x13, 0x14, 0x1a].includes(id)) id = 0x1b;
      ...
      if (group.includes(id)) {
        for (let n of group) {
          ...
          if (s.mixedState !== state) {
            s.mixedState = state;
            if (s.parallel) s.parallel.mixedState = state;
          }
        }
      }
  };
  ...
  window.getScreenLinkGroup = function (id, includeDarkWorld) {
    ...
    if (layoutshuffle === "N" && crossedow === "N" && !entranceEnabled && [0x13, 0x14, 0x1a].includes(id)) id = 0x1b;
    let linkGroup = [id];
    if (includeDarkWorld && id < 0x40) linkGroup.push(id + 0x40);
    for (let group of getScreenLinks())
      if (group.includes(id))
        for (let n of group)
          if (!linkGroup.includes(n)) {
            linkGroup.push(n);
            if (includeDarkWorld && n < 0x40) linkGroup.push(n + 0x40);
          }
    return linkGroup;
  };

  window.clearMixedStates = function () {
    for (let screen of overworldScreens.values()) screen.mixedState = "unknown";
  };
  ...
  window.createEntranceConnector = function (regionStart, regionEnd, status, id) {
    if (!regionStart || !regionEnd) return;
    if (status !== "single" && status !== "both" && status !== "unknown") status = "unknown";
    ...
    if (status === "both") createEntranceConnectorEdge(regionEnd, regionStart);
  };
  ...
  window.deleteEntranceConnector = function (index, connector) {
    if (entranceConnectors[index] === connector) {
      ...
      if (connector.status === "both") deleteEntranceConnectorEdge(regionEnd, regionStart);
  ...
  window.toBase62 = function (k) {
    if (k < 10) return "" + k;
    if (k < 36) return String.fromCharCode(k + 55);
